...
import {ScrollView, View,AsyncStorage, Image,StatusBarIOS, TouchableOpacity } from 'react-native';
  ...
  render() {
    ...
    const { checked } = this.state;
       ...
       <Container>
          ...
          {/*first name  */}
              <View style={{flexDirection:'row',paddingHorizontal:30,paddingVertical:10, justifyContent:'space-around', alignItems:'center'}}>
